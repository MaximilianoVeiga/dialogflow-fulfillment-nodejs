...
V2_TO_V1_PLATFORM_NAME[PLATFORMS.GOOGLE_HANGOUTS] = 'hangouts';
V2_TO_V1_PLATFORM_NAME[PLATFORMS.TELEPHONY] = 'telephony';
// Custom
...
const V1_TO_V2_PLATFORM_NAME = {
  ...
  hangouts: PLATFORMS.GOOGLE_HANGOUTS,
  telephony: PLATFORMS.TELEPHONY,
  // CUSTOM
